...
from . import views
from .views import send_location, get_locations
...
urlpatterns=[
    path('send-location/', send_location, name='send_location'),
    ...
    path('custom-admin/', custom_admin_view, name='custom_admin_view'),
]
